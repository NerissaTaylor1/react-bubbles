...
token used for authenication to see if you have access to  be on there
...
stored code on a website, or a program that serve web pages , serve web pages it retrieves from your code to users upon request.
